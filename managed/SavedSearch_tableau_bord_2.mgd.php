      ...
      'values' => [
        ...
        'api_params' => [
          ...
          'select' => [
            ...
            'Arriv_e_du_corps_new.Retrait_Stimulateur_piles:label',
...
Alertes si : restitution, pas de numéro de décès ou de code barres, stimulateur à piles non vérifié, pièce non localisée'),
          ...
          'columns' => [
            ...
            [
              'type' => 'field',
              'key' => 'Arriv_e_du_corps_new.Retrait_Stimulateur_piles:label',
              'dataType' => 'String',
              'label' => E::ts('Stimulateur à piles'),
              'sortable' => TRUE,
              'cssRules' => [
                [
                  'bg-danger',
                  'Arriv_e_du_corps_new.Retrait_Stimulateur_piles:name',
                  '=',
                  'A vérifier',
                ],
                [
