...
return [
  ...
  [
    'name' => 'OptionGroup_Arriv_e_du_corps_Effets_personnels',
    'entity' => 'OptionGroup',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      'version' => 4,
      'values' => [
        'name' => 'Arriv_e_du_corps_Effets_personnels',
        'title' => E::ts('Arrivée du corps :: Effets personnels'),
        'data_type' => 'Int',
        'is_reserved' => FALSE,
  ...
  [
    'name' => 'OptionGroup_Arriv_e_du_corps_Effets_personnels_OptionValue_Aucun',
    'entity' => 'OptionValue',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      'version' => 4,
      'values' => [
        'option_group_id.name' => 'Arriv_e_du_corps_Effets_personnels',
        'label' => E::ts('aucun'),
        'value' => '3',
        'name' => 'Aucun',
      ],
  ...
  [
    'name' => 'OptionGroup_Arriv_e_du_corps_Effets_personnels_OptionValue_restituer',
    'entity' => 'OptionValue',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
  ...
  [
    'name' => 'OptionGroup_Arriv_e_du_corps_Effets_personnels_OptionValue_d_truire',
    'entity' => 'OptionValue',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
  ...
  [
    'name' => 'CustomGroup_Arriv_e_du_corps_new_CustomField_Effets_personnels',
    'entity' => 'CustomField',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      ...
      'values' => [
        ...
        'note_columns' => 60,
        'note_rows' => 4,
        'column_name' => 'effets_personnels_114',
        'option_group_id.name' => 'Arriv_e_du_corps_Effets_personnels',
        'in_selector' => TRUE,
      ],
      'match' => [
