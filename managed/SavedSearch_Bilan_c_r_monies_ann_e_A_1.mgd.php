...
return [
  [
    'name' => 'SavedSearch_Bilan_c_r_monies_ann_e_A_1',
    'entity' => 'SavedSearch',
    'cleanup' => 'unused',
    'update' => 'unmodified',
    'params' => [
      'version' => 4,
      'values' => [
        'name' => 'Bilan_c_r_monies_ann_e_A_1',
        'label' => E::ts('Bilan : cérémonies année A-1'),
        'api_entity' => 'Event',
        'api_params' => [
          'version' => 4,
          'select' => [
  ...
  [
    'name' => 'SavedSearch_Bilan_c_r_monies_ann_e_A_1_SearchDisplay_Bilan_c_r_monies_ann_e_A_1_Table_1',
    ...
    'params' => [
      'version' => 4,
      'values' => [
        'name' => 'Bilan_c_r_monies_ann_e_A_1_Table_1',
        'label' => E::ts('cérémonies A-1 Table 1'),
        'saved_search_id.name' => 'Bilan_c_r_monies_ann_e_A_1',
        'type' => 'table',
        'settings' => [
          'description' => E::ts(''),
          'sort' => [
